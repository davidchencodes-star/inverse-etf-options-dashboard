...
def register_data_refresh_callbacks(app):
    ...
    @app.callback(
        ...
        Output("sp500-rsi-line", "children"),
        Output("sp500-badge", "children"),
        Output("sp500-badge", "color"),
        Output("sp500-card", "className"),
        # Nasdaq card outputs
        Output("nasdaq-price", "children"),
        Output("nasdaq-sma-line", "children"),
        Output("nasdaq-rsi-line", "children"),
        Output("nasdaq-badge", "children"),
        Output("nasdaq-badge", "color"),
        Output("nasdaq-card", "className"),
